 ...
 */
#ifdef CONFIG_SCHED_BORE
unsigned int sysctl_sched_wakeup_granularity			= 800000ULL;
static unsigned int normalized_sysctl_sched_wakeup_granularity	= 800000ULL;
#else // CONFIG_SCHED_BORE
...
uint __read_mostly sched_burst_penalty_scale    = 950;
